function [x, R] = OMP4(phi, y, epsilon)

%  [x, R] = OMP4(phi, y, epsilon)
%
% Four-dimensional Orthogonal Matching Pursuit recursive reconstruction algorithm
% for compressive sampling.
%
% This solves the inverse problem y = phi*x, by finding x (N X 4 matrix),
% where A = M X N X 4 measurement array, y = M X 4 measurement matrix.
...
% threshold, epsilon
%
% Created: Ra Inta, October 13, 2011 (as OMP.m)
% Last modified: Nov 15, 2012 R.I.
